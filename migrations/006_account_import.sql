-- Account import support (BeOn3 migration).
--
-- Imported accounts are created with password_hash = NULL and import_pending =
-- TRUE: their original credentials use incompatible crypto (BeOn3 = SHA-256+salt)
...
--   imported_from   source system tag (e.g. 'beon3'); NULL for native accounts.
