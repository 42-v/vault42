...
func TestImportUsers(t *testing.T) {
	t.Run("imports new accounts and strips admin roles", func(t *testing.T) {
		...
		body := `{"source":"beon3","users":[
			{"email":"A@Beon3.test","roles":["moderator","admin"],"banned":true,"ban_reason":"x","legacy_id":"00000000-0000-0000-0000-000000000009"}
		]}`
		...
		if u.ImportedFrom != "beon3" || !u.Banned {
