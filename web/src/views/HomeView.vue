      ...
      <div class="max-w-4xl mx-auto px-4 sm:px-6 py-8 space-y-6">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <div class="vault42-card flex items-start gap-4">
            ...
            >
              <svg aria-hidden="true" class="w-5 h-5" :class="(mfaStatus?.totp_enabled || mfaStatus?.webauthn_enabled) ? 'text-vault42-success' : 'text-vault42-error'" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div>
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <router-link to="/profile" class="vault42-card group hover:border-vault42-accent/50 transition-colors flex items-center gap-4">
              <div class="w-9 h-9 rounded-lg bg-vault42-border flex items-center justify-center group-hover:bg-vault42-primary/15 transition-colors">
                <svg aria-hidden="true" class="w-4 h-4 text-vault42-muted group-hover:text-vault42-accent transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                </svg>
              </div>
              <div>
                <p class="text-sm font-medium group-hover:text-vault42-accent transition-colors">{{ t('home.profile') }}</p>
                <p class="text-xs text-vault42-muted">{{ t('home.profileDesc') }}</p>
              </div>
            </router-link>

            <router-link to="/sessions" class="vault42-card group hover:border-vault42-accent/50 transition-colors flex items-center gap-4">
              <div class="w-9 h-9 rounded-lg bg-vault42-border flex items-center justify-center group-hover:bg-vault42-primary/15 transition-colors">
                <svg aria-hidden="true" class="w-4 h-4 text-vault42-muted group-hover:text-vault42-accent transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div>
                <p class="text-sm font-medium group-hover:text-vault42-accent transition-colors">{{ t('home.sessionsDevices') }}</p>
                <p class="text-xs text-vault42-muted">{{ t('home.sessionsDevicesDesc') }}</p>
              </div>
            </router-link>

            <router-link to="/2fa" class="vault42-card group hover:border-vault42-accent/50 transition-colors flex items-center gap-4">
              <div class="w-9 h-9 rounded-lg bg-vault42-border flex items-center justify-center group-hover:bg-vault42-primary/15 transition-colors">
                <svg aria-hidden="true" class="w-4 h-4 text-vault42-muted group-hover:text-vault42-accent transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div>
                <p class="text-sm font-medium group-hover:text-vault42-accent transition-colors">{{ t('home.twoFactorAuth') }}</p>
                <p class="text-xs text-vault42-muted">{{ t('home.twoFactorAuthDesc') }}</p>
              </div>
            </router-link>

            <router-link to="/password" class="vault42-card group hover:border-vault42-accent/50 transition-colors flex items-center gap-4">
              <div class="w-9 h-9 rounded-lg bg-vault42-border flex items-center justify-center group-hover:bg-vault42-primary/15 transition-colors">
                <svg aria-hidden="true" class="w-4 h-4 text-vault42-muted group-hover:text-vault42-accent transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 7a2 2 0 012 2m4 0a6 6 0 01-7.743 5.743L11 17H9v2H7v2H4a1 1 0 01-1-1v-2.586a1 1 0 01.293-.707l5.964-5.964A6 6 0 1121 9z" />
                </svg>
              ...
              <div>
                <p class="text-sm font-medium group-hover:text-vault42-accent transition-colors">{{ t('home.changePassword') }}</p>
                <p class="text-xs text-vault42-muted">{{ t('home.changePasswordDesc') }}</p>
              </div>
            </router-link>

            <router-link to="/identity" class="vault42-card group hover:border-vault42-accent/50 transition-colors flex items-center gap-4">
              <div class="w-9 h-9 rounded-lg bg-vault42-border flex items-center justify-center group-hover:bg-vault42-primary/15 transition-colors">
                <svg aria-hidden="true" class="w-4 h-4 text-vault42-muted group-hover:text-vault42-accent transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div>
                <p class="text-sm font-medium group-hover:text-vault42-accent transition-colors">{{ t('home.personalInfo') }}</p>
                <p class="text-xs text-vault42-muted">{{ t('home.personalInfoDesc') }}</p>
              </div>
            </router-link>

            <router-link to="/storage" class="vault42-card group hover:border-vault42-accent/50 transition-colors flex items-center gap-4">
              <div class="w-9 h-9 rounded-lg bg-vault42-border flex items-center justify-center group-hover:bg-vault42-primary/15 transition-colors">
                <svg aria-hidden="true" class="w-4 h-4 text-vault42-muted group-hover:text-vault42-accent transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div>
                <p class="text-sm font-medium group-hover:text-vault42-accent transition-colors">{{ t('home.encryptedStorage') }}</p>
      ...
      <div class="max-w-2xl mx-auto px-4 sm:px-6 py-20 text-center">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 mt-16 text-left">
          <div class="vault42-card">
            <div class="text-vault42-accent text-lg mb-2">&#x1f512;</div>
