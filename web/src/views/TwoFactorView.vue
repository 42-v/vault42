  ...
  <VaultAuthGuard>
    <template #default>
      <div class="max-w-lg mx-auto px-4 sm:px-6 py-8 space-y-6">
        ...
        <div v-if="isVerified || mfaStatus?.totp_enabled" class="vault42-card">
          <div class="flex items-center justify-between">
            <div class="flex items-center gap-3">
              <div class="w-10 h-10 rounded-full bg-vault42-success/15 flex items-center justify-center flex-shrink-0">
        ...
        <div class="vault42-card">
          <div class="flex items-start gap-4">
            <div class="w-10 h-10 rounded-lg bg-vault42-border flex items-center justify-center flex-shrink-0">
